...
public class RobotPlayer {
    ...
    final static int MAX_DIST = 2*100*100;
    ...
    public static void run(RobotController rc) {
        ...
        RobotType[] robotTypes = {RobotType.SCOUT, RobotType.SOLDIER, RobotType.SOLDIER, RobotType.SOLDIER,
                RobotType.GUARD, RobotType.GUARD, RobotType.GUARD, RobotType.TURRET};
                ...
                try {
                    ...
                    if (rc.isCoreReady()) {
                        if(rc.getType() == RobotType.ARCHON) {
                            ...
                            RobotInfo closest = closestRobot(enemies);
                            if(closest != null) {
                                Direction dir = rc.getLocation().directionTo(closest.location).opposite();
                                dir = findPathDirection(rc, dir);
                                if(rc.canMove(dir)) {
                                    rc.move(dir);
                                }
                            }
